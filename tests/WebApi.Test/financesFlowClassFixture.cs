...
public class financesFlowClassFixture : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _httpClient;

    public financesFlowClassFixture(CustomWebApplicationFactory webApplicationFactory)
    {
