...
namespace WebApi.Test.Arquivo
{
    public class GeraArquivoDespesasTest : financesFlowClassFixture
    {
        ...
        public GeraArquivoDespesasTest(CustomWebApplicationFactory webApplicationFactory) : base(webApplicationFactory)
        {
