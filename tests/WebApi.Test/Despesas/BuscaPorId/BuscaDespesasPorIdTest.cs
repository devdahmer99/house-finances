...
namespace WebApi.Test.Despesas.BuscaPorId
{
    public class BuscaDespesasPorIdTest : financesFlowClassFixture
    {
        ...
        public BuscaDespesasPorIdTest(CustomWebApplicationFactory webApplicationFactory) : base(webApplicationFactory)
        {
        ...
        public async Task Success()
        {
            ...
            Enum.IsDefined(typeof(MetodoPagamento), paymentType).Should().BeTrue();
        }
