...
namespace WebApi.Test.Usuarios.Perfil
{
    public class BuscaPerfilUsuarioTest : financesFlowClassFixture
    {
        ...
        public BuscaPerfilUsuarioTest(CustomWebApplicationFactory webApplicationFactory) : base(webApplicationFactory)
        {
